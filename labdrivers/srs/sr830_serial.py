...
class Sr830_serial:
    ...
    def __init__(self, mode='visa', resource_name=None, timeout=10.0, bytes_to_read=2048, baudrate = 9600, gpib_addr = None):
        ...
        if mode == 'visa':
            ...
            self._instrument = self.resource_manager.open_resource(self.resource_name)
    ...
    def frequency(self):
        ...
        """
        return self._instrument.query_ascii_values('FREQ?\n')[0]
    ...
    @property
    def sensitivitynum(self):
        """Voltage/current sensitivity for inputs."""
        sensitivity = {0: 2e-9,		13: 50e-6,
                       1: 5e-9,		14: 100e-6,
                       2: 10e-9,	    15: 200e-6,
                       3: 20e-9,	    16: 500e-6,
                       4: 50e-9,	    17: 1e-3,
    ...
    def auto_offset(self, parameter):
        ...
        """
        self._instrument.write("AOFF {}".format(parameter.upper()))
