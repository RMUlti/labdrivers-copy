"""Module containing a class to interface with a Keithley 6221 SMU
...
class Keithley6221():
    ...
    def _rampOutput(self, rampStart, rampTarget, nSteps=1000, timeStep=50E-3):
        ...
        for sourceValue in linspace(rampStart, rampTarget, nSteps+1):
            self.setSourceDC(sourceValue)
            time.sleep(timeStep)
